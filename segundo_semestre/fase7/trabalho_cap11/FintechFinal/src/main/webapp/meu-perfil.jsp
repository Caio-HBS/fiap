...
<html>
  <head>
    <title>Fintech | Meu perfil</title>
  ...
  <body class="index-cover">
    ...
    >
      <div class="col-12 col-md-6 col-lg-4">
        <div class="text-white bg-light-subtle p-3 rounded-3 needs-validation">
          <form
            onsubmit="return confirm('Tem certeza de que deseja apagar suas informa&ccedil;&otilde;es?');"
            action="meu-perfil?acao=deletar"
            method="post"
          >
            <button class="btn btn-danger"><b>Remover perfil</b></button>
          </form>
          <form action="meu-perfil?acao=atualizar" method="post">
            <h1 class="text-black text-center mt-4 mb-4">Meu perfil</h1>
            ...
            <div class="input-group mb-3">
              ...
              <div class="input-group-text ms-3">
                ...
                value="true" name="novidades-novo"
