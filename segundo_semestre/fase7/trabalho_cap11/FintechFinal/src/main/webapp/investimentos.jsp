      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            >
              <label for="nome-investimento"><b>Nome do investimento</b></label>
              <input
                type="text"
                class="form-control"
      ...
      <c:choose>
            ...
            <tbody class="lead">
              <c:forEach items="${investimentos}" var="inv" varStatus="status">
                <tr>
                  ...
                  <td>
                    ${fn:length(inv.nomeInvestimento) > 10 ?
                    fn:substring(inv.nomeInvestimento, 0, 10) :
                  ...
                  <td>
                    <a
                      href="investimento?id=${inv.idInvestimento}"
        ...
        <c:otherwise>
          <p class="h1 text-center pt-5">
            Voc&ecirc; ainda n&atilde;o tem nenhum investimento cadastrado
          </p>
        </c:otherwise>
      </c:choose>
    </main>
